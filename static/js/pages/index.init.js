...
(function () {
    ...
    var dummyImage = "static/images/users/user-dummy-img.jpg";
  
    var currentSelectedChat = "users";
    var url = window.location.origin + "/static/js/dir/";
    var usersList = "";
    var userChatId = 1;
    ...
    // HERE TO ADD MESSAGE RETURNING FROM TAYLOR
    // Create a function here.
    function askTaylor(question) {
      $(".chat-input-typing").removeClass("d-none");

      $.get( "https://taylor-api.quant4x.com/question", { 
          question: question
      }, function(){
      }).done(function(response) {
          $(".chat-input-typing").addClass("d-none");
          getChatList(2, "users-chat", response.toString().replace(/"/g,""));
    ...
    //Append New Message
    var getChatList = function (fromid, chatid, chatItems) {
      messageIds++;
      ...
      if( fromid == 2 ){
        side = "left";
        msgHTML = '<div class="chat-avatar"><img src="https://dashboard.quant4x.com/static/images/users/taylor_character.jpg" alt=""></div>';
      }
      ...
      if (chatItems != null) {
        ...
        itemList.insertAdjacentHTML(
          "beforeend",
          '<li class="chat-list '+side+'" id="chat-list-' +
            messageIds +
            '" >\
                  <div class="conversation-list">\
                  '+msgHTML+'\
        ...
        // HERE TO SEND A METHOD GET TO TAYLOR TO OBTAIN THE RESPONSE.
        if( fromid == 1){
          askTaylor(chatItems);
        }
      }
      ...
      chatForm.addEventListener("submit", function (e) {
        ...
        if (chatInputValue.length === 0) {
          ...
          if (isreplyMessage == true) {
            ...
            // HERE TO DETECT THE CHAT BEEN SENT
            getChatList(1, chatId, chatInputValue);
    ...
    // function addMessage( id, from_id,  msg ){
    //   var chatsData =
    ...
    //   var isAlighn = from_id == userChatId ? " right" : " left";
    //   var user = usersList.find(function (list) {
    //     return list.id == from_id;
    //   });
    //   var msgHTML =
    //     '<li class="chat-list' +
    //     isAlighn +
    ...
    //   ) {
    //     isContinue = getNextMsgCounts(chatsData, index, from_id);
    //     msgHTML += getNextMsgs(
    //       chatsData,
    //       index,
    //       isChat.from_id,
